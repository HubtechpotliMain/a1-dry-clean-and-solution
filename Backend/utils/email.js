...
const emailTemplates = {
  welcome: (data) => ({
    subject: 'Welcome to Kamal_Travy !',
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2 style="color: #2563eb;">Welcome to Kamal_Travy !</h2>
        <p>Hi ${data.name},</p>
        <p>Thank you for registering with Kamal_Travy ! We're excited to have you as part of our community.</p>
        ...
        <p>Best regards,<br>The Kamal_Travy  Team</p>
      </div>
    `
  }),
  ...
  'ticket-status-update': (data) => ({
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>Best regards,<br>The Kamal_Travy  Support Team</p>
      </div>
    `
  }),
  ...
  'inquiry-confirmation': (data) => ({
    subject: 'Thank you for contacting Kamal_Travy ',
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
  ...
  'availability-confirmation': (data) => ({
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>Best regards,<br>The Kamal_Travy  Sales Team</p>
      </div>
    `
  })
};
...
const sendEmail = async ({ to, subject, template, data }) => {
  try {
    ...
    const info = await transporter.sendMail({
      from: `"Kamal_Travy " <${process.env.EMAIL_USER}>`,
      to: to,
...
const testEmail = async () => {
  try {
    await sendEmail({
      ...
      subject: 'Test Email from Kamal_Travy  Backend',
      template: 'welcome',
      data: {
        name: 'Test User',
